...
import { ArrowLeft, CalendarDays, Copy, Share2, SquarePen } from "lucide-react";
  ...
  function handleCopyUrlProfile() {
    copy(profileUrl).then(() => {
      toast({
        ...
        description: "O link do seu perfil foi copiado com sucesso.",
      });
    });
  }
  ...
  return (
    <MainLayout>
      <main className="flex-1 w-full border-x border-border/40 lg:max-w-5xl">
        {/* Cover Image */}
        <div className="h-48 lg:h-64 bg-muted">
        ...
        <div className="px-4 pb-4 -mt-20">
          <div className="flex justify-between items-start mb-4">
            <Avatar className="h-32 w-32 rounded-full border-4 border-background">
              ...
              {/* Carregar icone e cor do avatar */}
            </Avatar>
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Faça mudanças no seu perfil aqui. Clique em salvar
                        quando terminar.
                      </DialogDescription>
                    </DialogHeader>
